...
public class StringManipulation {
    public static void main(String[] args) {
        ...
        // sec- windowCount: to store the frequency of characters in the current window
        // of size s1
        // use two poiners - start end to denote current window
        // expand the window by moving the end pointer until all characters in s2 are
        // covered.
        // once a valid window is found, shrink it from left by moving start pointer
        // forward to minimize the window.
    }
